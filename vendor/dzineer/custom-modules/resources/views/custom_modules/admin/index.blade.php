...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="heading-info">All Modules</h4>

            <div class="row p-x-10">
                <span class="popular-star p-x-10"><i class="fa fa-star"></i></span>Featured modules
                <span class="core-module-star p-x-10"><i class="fa fa-star"></i></span>Core modules
            </div>
...
{{--            <div class="row">
            ...
            <div class="row p-x-10">
                ...
                @foreach( $modules as $module )
		            ...
		            <?php
		            $link = $module['in'] ? '/modules?module=' . strtolower($module['module_name']) : '/modules?module=' . strtolower($module['module_name']) . '&action=add';
		            ...
		            $systemModule = $module['module_type']['type'] === 'app_module';
		            ?>

                    @if($hasModule && ! $systemModule )
            ...
            <h5 class="m-y-20 p-x-10" style="color: #3C8DBC;">Installed System Modules (<em style="color:red">system core features.</em>)</h5>
                            ...
                            <div class="card app">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="#" class="app-module" data-module-base-url="{{ url()->current() }}" data-module-id="{{ $module['id'] }}" data-has-module="{{ $hasModule }}" data-custom-module-id="{{ $customModuleId }}" data-module-title="{{ $module['name'] }}" data-module-name="{{ $module['module_name'] }}" data-module-type="{{ $module['module_type']['description'] }}" data-module-browse='true' <?php echo $module['status'] === 1 && $module['in'] ? "data-module-active='true'" : '' ?>  <?php echo $module['featured'] === 1 ? "data-module-featured='true'" : '' ?>  data-module-linktype="{{  $linkType }}" data-module-config="{{ $link }}" >
                                        ...
                                        <span class="core-module-star"><i class="fa fa-star"></i></span>
                                    </a>
            ...
            <h5 class="m-y-20 p-x-10" style="color: #3C8DBC;">Available Modules</h5>
    ...
    <script>
        ...
        jQuery('#delete-button').on('click', function(e) {
            ...
            jQuery('#confirm-delete').find('.modal-body').html(
                ...
                '<p>' + 'Deleting this module will delete all clients installation of this module.' + '</p>' +
