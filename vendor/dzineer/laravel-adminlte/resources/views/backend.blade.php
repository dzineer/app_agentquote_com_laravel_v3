...
<div id="backend-support-popup"></div>
    ...
    <div id="sticky-container">
        <div class="support-container">
            <a href="/videos">
                ...
                <a href="https://www.agentquoter.com/billing/submitticket.php?step=2&deptid=2" class="contact-link p-y-20">Contact Support</a>
            </a>

        </div>
    </div>
    <div class="sticky-button" id="support-button">
        <img src="/images/life-support-icon.svg" height="25" width="25">
    </div>
</div>--}}
...
/*    jQuery(function() {
        (function($) {
            var opened = false;
            var supportContainer = $('#sticky-container');
