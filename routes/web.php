...
Route::group(['middleware' => ['auth']], function () {
   ...
   // Route::get('/push', [\App\Http\Controllers\PushNotificationsController::class,'push'])->name('push');
    ...
    Route::post('/super.super/user/login', [\App\Http\Controllers\SuperSuperController::class, 'loginAsUser'])->name('super.super.users.login');
...
//	Route::get('/', [\App\Http\Controllers\HomeController::class, 'index']);
    ...
    Route::get('profile/language/settings', [\App\Http\Controllers\UsersLanguageController::class, 'settings'])->name('user.landing-page.profile.languages.settings');
    Route::put('profile/language/usettings', [\App\Http\Controllers\UsersLanguageController::class, 'usettings'])->name('user.landing-page.profile.languages.usettings');
