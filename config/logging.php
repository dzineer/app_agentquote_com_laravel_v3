...
return [
    ...
    */
    ...
    'channels' => [
        ...
        'agentquoteLog' => [
            'driver' => 'single',
            'path' => storage_path('logs/agentquote.log'),
            'level' => 'info',
        ],
        ...
        'agentquoteNetworkReceivedLog' => [
            'driver' => 'single',
            'path' => storage_path('logs/agentquote-network-received.log'),
            'level' => 'info',
        ],

        'agentquoteNetworkResponseLog' => [
            'driver' => 'single',
            'path' => storage_path('logs/agentquote-network-response.log'),
            'level' => 'info',
        ],

        'agentquoteErrorsLog' => [
            'driver' => 'single',
            'path' => storage_path('logs/agentquote-errors.log'),
            'level' => 'info',
        ],
