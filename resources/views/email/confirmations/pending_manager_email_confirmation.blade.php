...
Your affiliate has send you a manager invite. Accept this invitation click the link below:<br>
...
<br>
[{{ config('agentquote.company.domain.urls.secure') }}/invite/confirmation?confirmation_token={{ $data['confirmation_token']}}]({{ config('agentquote.company.domain.urls.secure') }}/invite/confirmation?confirmation_token={{ $data['confirmation_token']}})
