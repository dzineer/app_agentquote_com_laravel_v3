            ...
            <div class="cell-xs-6">
                <div class="unit unit-xs-horizontal">
                    ...
                    <div class="unit-body">
                        ...
                        <div class="text-italic"><a class="text-gray-lighter" href="tel:#">{{ company_phone($company) }}</a><span class="text-gray-lighter">; </span><br><a class="text-gray-lighter" href="tel:#">>{{ $phone[1] }}</a></div>
                    </div>
                </div>
            </div>
