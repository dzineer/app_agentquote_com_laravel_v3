<section class="section-60 section-md-top-80 section-md-bottom-100" id="contacts">
    <div class="shell">
        ...
        <!-- RD Mailform-->
        <form class="rd-mailform text-left offset-top-30" data-form-output="form-output-global" data-form-type="contact" method="post" action="{{ asset_prepend('templates/landing-pages/v1/', 'bat/rd-mailform.php') }}">
