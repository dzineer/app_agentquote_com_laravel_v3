...
<head>
    ...
    @include("landing-pages.v2.pages.quote.metas")

    <link rel="icon" href="{{ asset_prepend('templates/landing-pages/' . $version . '/', 'images/favicon.ico') }}" type="image/x-icon">

    <!-- Stylesheets -->
    @include("landing-pages.v2.pages.quote.styles")

    <!-- Browser Conditionals -->
    @include("landing-pages.v2.pages.quote.browser-conditionals")
</head>
<body>
...
<div class="page text-center">
    ...
    <!-- Page Header -->
    @include("landing-pages.v2.pages.quote.sections.header")

    <!-- Quote Form -->
    @include("landing-pages.v2.pages.quote.sections.section-quote-contents")
...
<!-- Modals -->
@include("landing-pages.v2.pages.quote.modals.index")

<!-- Scripts -->
@include("landing-pages.v2.pages.quote.scripts")
