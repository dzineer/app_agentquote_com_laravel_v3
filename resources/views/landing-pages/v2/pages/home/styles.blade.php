...
<link rel="stylesheet" href="{{ asset_prepend('templates/landing-pages/' . $version . '/', 'css/dz-fa.css') }}">
<link rel="stylesheet" href="{{ asset_prepend('templates/landing-pages/' . $version . '/', 'css/dz-fa-5.css') }}">
