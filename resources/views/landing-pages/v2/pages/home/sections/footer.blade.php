...
{{--                                    @if(! empty( $company['phone']) )
                                    <br class="veil-lg"><a href="tel:{!! $company['phone'] !!}">{!! $company['phone'] !!}</a>
                                    @endif--}}
                                </div>
                            </div>
                        </div>
        ...
        <div class="shell footer-container footer-copyright">
            <div class="reveal-sm-flex range-sm-justify range-sm-reverse range-sm-middle">
                ...
                <div class="offset-top-15 offset-sm-top-0">
                    <p>&#169; <span class="copyright-year"></span> <a href="https://agentquote.com"><span class="text-primary">{{ $branding['copyright'] }}</span></a> <a href="https://agentquote.com">Privacy Policy</a>
                    </p>
                </div>
            </div>
        </div>
