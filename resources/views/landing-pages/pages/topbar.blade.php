        ...
        <brand-bar>
            ...
            <div slot="right">
                <div class="tw-flex tw-flex-col">
                    ...
                    <a class="tw-bg-primary hover:tw-bg-blue-700 tw-text-white tw-border tw-text-center tw-py-4 tw-px-6 focus:tw-outline-none focus:tw-shadow-outline tw-uppercase tw-text-base tw-font-bold">
                        book an appointment
                    </a>
                </div>
            </div>
