        <div class="tw-w-full tw-py-8 tw-bg-gray-200">
            <div class="tw-w-full tw-flex-col md:tw-flex-row tw-px-6 sm:tw-w-11/12 md:tw-w-11/12 lg:tw-w-11/12 tw-flex tw-justify-end tw-items-center tw-mx-auto tw-h-full">
                <div class="tw-w-full py-4 md:tw-px-4 tw-flex tw-flex-col tw-justify-center tw-items-center tw-leading-normal">
                    ...
                    <p id="featured-tips" class="tw-text-2xl xl:tw-text-3xl tw-my-6 tw-font-light tw-tracking-tight tw-font-semibold tw-text-primary"  aria-label="Three Features Below">
                        Featured Tips
                    </p>

                    <div class="tw-flex tw-flex-col md:tw-flex-row tw-justify-center tw-items-center tw-w-full">

                        <a href="/featured-tips/what-happens-to-my-policy-if-i-change-my-mortgage" class="tw-cursor-pointer" aria-labelledby=="why-life-insurance-makes-sense"><div class="tw-relative tw-w-full tw-flex tw-justify-center tw-items-center tw-relative dz-product-box dz-product-box tw-my-2 md:tw-my-0">
                            ...
                            <div class="tw-absolute tw-bg-blue-600 tw-inset-0 tw-opacity-0 product-cover tw-flex tw-flex-col tw-justify-center tw-justify-items">
                                <p class="tw-flex tw-justify-center tw-items-center tw-text-white tw-text-xl tw-text-center tw-px-1" id="why-life-insurance-makes-sense">Why life mortgage insurance makes sense.</p>
                            ...
                            <div class="tw-absolute tw-inset-x-0 tw-bottom-0 tw-flex tw-justify-center tw-items-center tw-bg-white product-title">
                                <p class="tw-p-4">Why life mortgage insurance makes sense.</p>
                            </div>
                        </div></a>
