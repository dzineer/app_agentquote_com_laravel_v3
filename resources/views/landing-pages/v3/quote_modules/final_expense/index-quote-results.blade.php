...
<head>
    ...
    <!-- Scripts -->
    @include("landing-pages." . $version . ".quote_modules.final_expense.quote-results-scripts")
...
<!-- Quote Form -->
    @include("landing-pages." . $version . ".quote_modules.final_expense.sections.section-quote-contents")
