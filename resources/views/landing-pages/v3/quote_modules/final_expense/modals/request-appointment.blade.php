        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content inset-md-left-30 inset-md-right-30">
                ...
                <div class="modal-body">
                    ...
                    <hr class="divider">
                    <!-- RD Mailform-->
                    <form class="rd-mailform text-left" data-form-output="form-output-global" data-form-type="contact" method="post" action="{{ asset_prepend('templates/landing-pages/' . $version . '/', 'bat/rd-mailform.php') }}">
                        <div>
