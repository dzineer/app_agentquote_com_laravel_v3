...
<div class="fluid-container">
    ...
    <div class="aq-header-footer">
        <div class="aq-header-footer-container">
            <img src="https://app.agentquoter.com/images/AQ_Logo_trns.png" />
        </div>
    </div>
    ...
    <div class="row">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div id="loader">
                        <span id="page-loader"></span>
                    </div>
                </div>
                <div class="col-md-12">
                    <div id="SignUpCoupon"></div>
                </div>
            </div>
        </div>
    </div>
