...
@section('content_header')
    <h1>Module Config - User Custom Pages</h1>
@stop
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <a class="btn btn-secondary m-y-20" href="/modules?module=user_custom_pages_module&new=true">+ New Page</a>
            <ul class="list-group">
                @foreach($pages as $page)
                <li class="list-group-item"  style="cursor: pointer"><a href="{{ '/modules?module=user_custom_pages_module&page_id=' . $page['id'] }}" style="cursor: pointer">{{ ucfirst($page['name']) }}</a></li>
                @endforeach
            </ul>
        </div>
    </div>
