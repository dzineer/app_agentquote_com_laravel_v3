    ...
    <div class="card">
        <div class="card-body">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item"  style="cursor: pointer"><a href="{{ '/modules?module=pages_module&page_id=' . $section['page_id'] . '&section_id=' . $section['id'] }}" style="cursor: pointer">{{ ucfirst($section['section']) }}</a></li>
                @endforeach
            </ul>
        </div>
    </div>
