    ...
    <div class="card">
        <div class="card-body">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item"  style="cursor: pointer"><a href="{{ '/user/modules?module=user_pages_module&page_id=' . $page['id'] }}" style="cursor: pointer">{{ ucfirst($page['name']) }}</a></li>
                @endforeach
            </ul>
        </div>
    </div>
