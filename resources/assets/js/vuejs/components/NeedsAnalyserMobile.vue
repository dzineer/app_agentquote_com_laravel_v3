    ...
    <div v-if="show" class="tw-container tw-w-full md:tw-w-11/12 lg:tw-w-4/5 tw-flex tw-justify-center tw-items-center md:tw-no-margin">
        <div class="tw-w-full tw-bg-black na-container tw-rounded-t-xl tw-relative">
           ...
           <div class="tw-w-full tw-flex tw-justify-center tw-items-center" @click="closeNeedsAnalyser">
            ...
            <na-section icon="users" title="family income" :show="sectionStates.FAMILY_INCOME" @fieldChange="onFieldChange" @toggle="toggleState('FAMILY_INCOME')" @toggleNextState="toggleState('REPLACEMENT_INCOME')" :fields="currentSection()"></na-section>
            <na-section icon="refresh" title="income to be replaced" :show="sectionStates.REPLACEMENT_INCOME" @fieldChange="onFieldChange" @toggle="toggleState('REPLACEMENT_INCOME')" @toggleNextState="toggleState('INVESTIBLE_FAMILY_ASSETS')" :fields="currentSection()" ></na-section>
            <na-section id="" icon="university" title="investible family assets" :show="sectionStates.INVESTIBLE_FAMILY_ASSETS" @fieldChange="onFieldChange" @toggle="toggleState('INVESTIBLE_FAMILY_ASSETS')" @toggleNextState="toggleState('DEBIT_REPAYMENT')" :fields="currentSection()" ></na-section>
            ...
            <div v-show="show" class="fields tw-pb-3 tw-px-2">
