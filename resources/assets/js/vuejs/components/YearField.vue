<template>
    ...
    <div class="tw-flex tw-flex-wrap tw-items-stretch tw-w-full tw-mb-4 tw-relative">
        <input type="text" class="field-left-input tw-flex-shrink tw-flex-grow tw-flex-auto tw-leading-normal tw-w-px tw-flex-1 tw-border tw-px-3 tw-rtw-elative" :name="name" :value="value | formatAmount" @keyup="onFieldChange">
        <div class="tw-flex tw--mr-px">
            <span class="cents-symbol">year(s)</span>
        </div>	
    </div>
