...
export default {
    ...
    data() {
        return {
            ...
            sections: {
                family_income: [
                    { component: 'amount-field', name: 'gross_income', value: 0, placeholder: '0', text: 'your gross income', classes: 'tw-text-gray-800 tw-text-lg', readonly: false },
                    { component: 'amount-field', name: 'spouse_gross_income', placeholder: '0', value: 0, text: 'Spouse\'s Gross Income (Only include if this income would stop if you were to die) ?', classes: 'tw-text-gray-800 tw-text-lg', readonly: false },
                    { component: 'amount-field', name: 'other_gross_income', placeholder: '0', value: 0, text: 'Other Gross Income (Only include if this income would stop if you were to die) ?', classes: 'tw-text-gray-800 tw-text-lg', readonly: false },
                    { component: 'amount-field', name: 'total', value: 0, placeholder: '0', text: 'total gross income to be replaced', classes: 'tw-text-gray-800 tw-text-lg', readonly: true },
                ],
                replacement_income: [
                    { component: 'percentage-field', name: 'percent_income', value: 80, placeholder: '0', text: 'Desired annual income needs (typically 70-80% of current combined income) ?', classes: 'tw-text-gray-800 tw-text-lg', readonly: false },
                    { component: 'amount-field', name: 'total_replacement_income', placeholder: '0', value: 0, text: 'TOTAL REPLACEMENT INCOME NEEDED', classes: 'tw-text-gray-800 tw-text-lg', readonly: true },
                    ...
                    { component: 'percentage-field', name: 'rate_return', value: 0, placeholder: '5', text: 'Rate of Return ?', classes: 'tw-text-gray-800', readonly: false },
                    { component: 'percentage-field', name: 'rate_inflation', value: 0, placeholder: '3', text: 'Rate of Inflation ?', classes: 'tw-text-gray-800 tw-text-lg', readonly: false },
                    { component: 'percentage-field', name: 'net_rate_return', value: 0, placeholder: '1', text: 'Net Rate of Return', classes: 'tw-text-gray-800 tw-text-lg', readonly: true },
                    { component: 'amount-field', name: 'total', value: 0, placeholder: '0', text: 'INITIAL LIFE INSURANCE NEEDED TO REPLACE INCOME(BEFORE OTHER CALCULATIONS)', classes: 'tw-text-gray-800 tw-text-lg', readonly: true },
                ],
                investible_family_assets: [
                    { component: 'amount-field', name: 'savings', value: 0, placeholder: '0', text: 'Savings ?', classes: 'tw-text-gray-800 tw-text-lg', readonly: false },
                ...
                debt_repayment: [
                    ...
                    { component: 'amount-field', name: 'auto_loan',  value: 0, placeholder: '0', text: 'Auto Loan ?', classes: 'tw-text-gray-800 tw-text-lg', readonly: false },
                    { component: 'amount-field', name: 'consumer_debt',  value: 0, placeholder: '0', text: 'Consumer Debt ?', classes: 'tw-text-gray-800 tw-text-lg', readonly: false },
                    { component: 'amount-field', name: 'other_debt',  value: 0, placeholder: '0', text: 'Other Debt', classes: 'tw-text-gray-800 tw-text-lg', readonly: false },
                    { component: 'amount-field', name: 'total',  value: 0, placeholder: '0', text: 'TOTAL DEBT', classes: 'tw-text-gray-800 tw-text-lg', readonly: true },
                ],
                college_funding: [
                    { name:'children', text: 'Number of children',  value: 0, placeholder: '0', classes: '' },
                    { name:'total', text: 'Number of children',  value: 0, placeholder: '0', classes: '' },
                ],
                other_expenses: [
