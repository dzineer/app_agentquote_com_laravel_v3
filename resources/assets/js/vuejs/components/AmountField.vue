<template>
    <div class="field">
        ...
        <div class="tw-flex tw-flex-wrap tw-items-stretch tw-w-full tw-mb-1 tw-relative">
            ...
            <input type="text" class="field-between-input tw-flex-shrink tw-flex-grow tw-flex-auto tw-leading-normal tw-flex-1 tw-w-px tw-border tw-px-3" :name="name" :value="value | formatAmount" @keyup="onFieldChange" :disabled="readonly">
            <div class="tw-flex tw--mr-px">
