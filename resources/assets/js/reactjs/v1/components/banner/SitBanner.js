...
/** function: SitBanner */
class SitBanner extends Component {
    constructor(props) {
        super(props);
        this.banner = '';
        this.loader = {};
        ...
        this.insurance_details = (
            <div className="card" style={{border: 'none', 'width': '98%'}}>
                <div className="card-body">
                    <h5 className="card-title">Simplified Issue Term Insurance</h5>
    ...
    render() {
        ...
        render(
            <InsuranceDetails>{ this.state.insurance_details }</InsuranceDetails>,
        ...
        return (
            <div className="quote-container"
                ...
                <h2 style={this.styles.header}>Get An Instant Quote Below (SIT)</h2>
                <div className="row">
...
SitBanner.defaultProps = {
    statesArr: []
};

export default SitBanner;
