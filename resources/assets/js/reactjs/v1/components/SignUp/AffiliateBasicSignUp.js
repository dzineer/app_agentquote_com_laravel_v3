...
/** function: AffiliateBasicSignUp */
class AffiliateBasicSignUp extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            fields: {
                ...
                plan: {
                    plan_code: "aq2e_affiliate_program_basic",
                    // coupon: ''
                },
                user: {
                    login_id: '',
    ...
    onApplyCoupon = event => {
        ...
        promise.then( token => {
            ...
            let headers = {
                ...
                'token': token,
                'X-Agentquote-Api': '44CBBD68D0040C4FB1B365835A08FBF09D877D6A',
                'accountid': '834839489'
            };
            ...
            <div className="row">
                ...
                <div className="col-md-12">
                    <div style={new_styles.productBanner}>
                        Affiliate Program Complete Subscription
                    </div>
                </div>
                <div className="col-md-12">
                ...
                { products }
                { false && this.state.applied_discount && invoice_coupon }
                { false && this.state.config.use_coupon && ! this.state.applied_discount && coupon_form }
                <div className="col-md-12">
        ...
        const new_signup_content = (
            <div className="wrapper-a">
                <div className="form-group mb-3 signup-container">
                        ...
                        <div className="col-md-12" style={styles.formHeader}>
                                Affiliate Program Basic Subscription
                        </div>

                        <div className="col-sm-12 order-form-container no-padding mb-20 mt-0 form-group" style={styles.orderFormContainer}>
                            <div className="row">
                            ...
                            <div className="col-md-12">
                                    <div className="form-group account-info-container">
                                        ...
                                        <div className="row form-group">
                                            <div className="col-sm-12 control-group">
                                                <input type="email" name="email" id="email" data-field-type="account" className="form-control"  value={this.state.fields.email} onChange={(e) => {this.onFormFieldChange('account', e)}} placeholder="Email*" is_mandatory="true" />
                                        ...
                                        <div className="row form-group">
                                            ...
                                            <div className="col-sm-6 control-group">
                                                <input type="text" name="company_name" id="company_name" data-field-type="account" className="form-control" value={this.state.fields.company_name} onChange={(e) => {this.onFormFieldChange('account', e)}} placeholder="Company*" is_mandatory="true"  />
...
AffiliateBasicSignUp.propTypes = {

};

AffiliateBasicSignUp.defaultProps = {
    //myProp: val
};

export default AffiliateBasicSignUp;

if (document.getElementById('affiliate-basic-signup')) {
    render(
        <AffiliateBasicSignUp />,
        document.getElementById('affiliate-basic-signup')
    )
}
