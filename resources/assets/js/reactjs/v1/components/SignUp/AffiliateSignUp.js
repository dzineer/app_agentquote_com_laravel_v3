...
class AffiliateSignUp extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            products: [
                {
                    name: 'Affiliate Program Complete',
                    em: 'Billed Monthly',
                    qty: 1,
                    price: 59.00,
                }
            ...
            fields: {
                ...
                plan: {
                    plan_code: "aq2e_affiliate_program_complete",
                    // coupon: ''
                },
                user: {
                    login_id: '',
...
AffiliateSignUp.propTypes = {

};

AffiliateSignUp.defaultProps = {
    //myProp: val
};

export default AffiliateSignUp;

if (document.getElementById('affiliate-signup')) {
    render(
        <AffiliateSignUp />,
        document.getElementById('affiliate-signup')
    )
}
