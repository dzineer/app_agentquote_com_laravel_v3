...
class TermLifeQuoteWidget extends Component {
    constructor(props) {
        super(props);
        this.state = {
            showForm: true,
    ...
    renderEmailMeThisQuote = () => {
        return (
            <input type="submit" id="email-group-btn" className="btn btn-primary btn-lg mt-2 py-0 w-100" value="email this quote" onClick={this.onGenQuoteRequest} />
        );
    };
    ...
    render()
    {
        return <div id="main-content-area">
                    <div className="header-container">
                        <h4>Hi {this.props.customerName}</h4>
                        <p>Start creating your quote below</p>
                    </div>
...
TermLifeQuoteWidget.defaultProps = {
    eventsRouter: () => {},
    statesArray: [],
    UserId: 0,
    customerName: '',
...
export default TermLifeQuoteWidget;

/*
if (document.getElementById('term-life-widget')) {
    render(
        <TermLifeQuoteWidget eventsRouter={ FD3EventsRouter } statesArray={ statesArray } UserId={ UserId } />,
        document.getElementById('term-life-widget')
    );
}
*/
