...
class AdminLine extends Component {
    ...
    updateAdministrator = (e) => {
        e.preventDefault();
        debugger;
        if (this.state.user.fname !== this.state.fields.fname) {
            this.props.onAdministratorUpdate({
                user_id: this.state.user.user_id,
                fname: this.state.fields.fname,
            });
            message.success('Administrator being updated...');
