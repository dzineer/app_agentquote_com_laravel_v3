...
/** class TermlifeModuleEdit */
class TermlifeModuleEdit extends Component {
...
TermlifeModuleEdit.propTypes = {
    customModule: PropTypes.object.isRequired,
    domains: PropTypes.array.isRequired
    //myProp: PropTypes.string.isRequired
};

TermlifeModuleEdit.defaultProps = {
    customModule: {},
    domains: [],
};

export default TermlifeModuleEdit;

if (document.getElementById('termlife-settings-edit')) {
    render(<TermlifeModuleEdit customModule={ customModule } domains={ domains } />,
        document.getElementById('termlife-settings-edit')
    );
}
