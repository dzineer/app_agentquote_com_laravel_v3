...
import UserAffiliateLine from "./UserAffiliateLine";
import Request from '../../utils/FD3Request';
import Pagination from "./Pagination";

/** class UsersAffiliateTable */
class UsersAffiliateTable extends Component {
    ...
    constructor(props) {
       ...
       this.onCheckboxChange.bind(this);
       this.affiliateChange.bind(this);
    }
    ...
    affiliateChange = (user_id, new_affiliate_id) => {
        ...
        let url = '/api/user/affiliate/change';
        ...
        Request.post(url,
            ...
            .then((data) => {
                ...
                if (typeof data.success !== "undefined" && data.success === true) {
                    this.message("success", data.message);
                    this.message("success", "reloading page...");
                    location.reload();
                }
                else if (typeof data.success !== "undefined" && data.success === false) {
                    this.message('error', data.message);
    ...
    render() {
        ...
        return (
            ...
            <div className="row">
                ...
                <div className="col-md-12 tablesorter-container">

                    <div className="">
                        <table className="table table-striped table-bordered tablesorter agents-list">
                            <thead>
                            <tr>
                                ...
                                <th className="sheader">Affiliate
                                </th>
                            ...
                            { this.state.agents.map( agent => {
                                return <UserAffiliateLine
                                    ...
                                    checked={this.state.checkboxes[agent['user_id']]}
                                    onUserUpdate={ this.updateUser }
                                    onPasswordReset={ this.passwordReset }
                                    onAffiliateChange={ this.affiliateChange } />
                            })}
...
UsersAffiliateTable.defaultProps = {
    affiliate_id: 0,
    user: {},
    agents: [],
    affiliates: [],
...
export default UsersAffiliateTable;

if (document.getElementById('users-affiliate-table')) {
    render(
        <UsersAffiliateTable user={user} agents={users} affiliates={affiliates} affiliate_id={affiliate_id} pagination={pagination} />,
        document.getElementById('users-affiliate-table')
    );
}
