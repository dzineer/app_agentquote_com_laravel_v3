...
import LeadsPanel from "../user/LeadsPanel";
    ...
    return (
        <form>
            ...
            <div className="form-group">
                <div className="row">
                    <div className="col-6">
                        <select id="aq2e_state" name="aq2e_state" className="form-control fill-parent lboState select-box-lg select-non-lg">
                            ...
                            <option className="aq2e-select-option" value="CA" selected="selected">California</option>
