...
class AffiliateMastForm extends Component {
    constructor(props) {
        super(props);
...
export default AffiliateMastForm;

if (document.getElementById('affiliate-mast')) {
    ReactDom.render(<AffiliateMastForm errors={[]} />,
        document.getElementById('affiliate-mast')
    );
}