...
import CapitalizeWords from "../Capitalize/CapitalizeWords"

/** class CustomModuleButton */
class CustomModuleButton extends Component {
    constructor(props) {
        super(props);
        this.state = {
            userModule: null,
    ...
    render() {
        ...
        return this.state.userModule &&
            <div id={ this.state.userModule.module.module_name + '-btn-container'} className="btn-container">
                ...
                <h4><CapitalizeWords text={ this.state.config.name } /></h4>
            </div>
    }
}

CustomModuleButton.propTypes = {
    CustomModuleName: PropTypes.string.isRequired,
    UserId: PropTypes.number.isRequired,
    onClick: PropTypes.func.isRequired
};

CustomModuleButton.defaultProps = {
    CustomModuleName: '',
    UserId: 0,
    onClick: () => {}
};

export default CustomModuleButton;
