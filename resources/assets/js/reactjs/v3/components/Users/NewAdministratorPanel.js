...
/** class NewAdministratorPanel */
class NewAdministratorPanel extends Component {
    constructor(props) {
        super(props);
        this.state = {
            fname: '',
...
NewAdministratorPanel.propTypes = {
    show: PropTypes.bool.isRequired,
    onCancel: PropTypes.func.isRequired,
    onNewAdmin: PropTypes.func.isRequired
};

NewAdministratorPanel.defaultProps = {
    show: false,
    onCancel: () => {},
    onNewAdmin: () => {}
};

export default NewAdministratorPanel;