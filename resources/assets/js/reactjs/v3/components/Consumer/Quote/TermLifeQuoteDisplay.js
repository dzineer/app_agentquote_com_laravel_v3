...
import TermLifeReQuoteModule from "../ReQuoteModules/TermLifeReQuoteModule";

/** class TermlifeQuoteDisplay */
class TermlifeQuoteDisplay extends Component {
    constructor(props) {
        super(props);
        this.state = {
            userModules: []
    ...
    render() {
        ...
        return (
            <div>
                ...
                <TermLifeReQuoteModule QuoteId={ quote_id } UserId={ user_id } />

                <h3 className="term-type-header">
                    Term Life Quote Results
                </h3>
...
TermlifeQuoteDisplay.propTypes = {
    /** myProp */
    quote_results: PropTypes.array.isRequired
};

TermlifeQuoteDisplay.defaultProps = {
    quote_results: []
};

export default TermlifeQuoteDisplay;

if (document.getElementById('termlife-quote-display')) {
    render(<TermlifeQuoteDisplay quote_results={quote_results}/>,
