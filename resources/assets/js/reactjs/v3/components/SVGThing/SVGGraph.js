...
class SVGGraph extends Component {
    ...
    generatePath() {
        ...
        let d = "M 11.3,246.2 c0,0,52.7-228.5,275.7-233.8S538,219.6,538,219.6 v 122.9 H 178.1 c0,0,26.3,212.4,307.3,82.5 v 114.1 c0,0-203.7,121.1-342.4-31.6 c0,0-172.1-207.2,70.2-352.9 c0,0-33.4,64.4-33.4,84 h205.4c0,0,3.5-82.2-57.9-103.3C327.3,135.3,206.2,56.9,11.3,246.2z";
...
render(
    <SVGGraph />,
    document.querySelector("#svg-graph")
)