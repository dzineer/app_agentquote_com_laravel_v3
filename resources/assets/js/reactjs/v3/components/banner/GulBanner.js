...
/** function: GULBanner */
class GULBanner extends Component {
    constructor(props) {
        super(props);
        this.banner = '';
        this.loader = {};
    ...
    render() {
        ...
        return (
            <div className="quote-container"
                ...
                <h2 style={this.styles.header}>Get An Instant Quote Below (GUL)</h2>
                <div className="row">
...
GULBanner.defaultProps = {
    statesArr: []
};

export default GULBanner;
