...
class QuoteItem extends Component {
    ...
    render() {
        const image_base_url = 'https://aq-cdn.s3-us-west-1.amazonaws.com' + '/logos/';
        const styles = {
            left: {
        ...
        return (
            <div className="quote-result">
                <div className="quote-results-container card card-body" style={this.styles.for.container} key={this.props.item.Rate1Adj}>

                    <div className="row no-margin" style={styles.topContainer}>

                        <div className="col-2 no-padding" style={styles.left}>
                        ...
                        <div className="col-10 no-padding" style={styles.right}>
                            <div className="row col-row no-margin">
                    ...
                    <div className="row no-margin bottom-info">
