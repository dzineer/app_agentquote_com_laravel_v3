...
/*        if (! (this.state.profile.logo || this.state.profile.portrait)) {
        ...
        if (this.state.profile.facebook_link && this.state.profile.facebook_link.length) {
            fd.append('facebook_link', this.state.profile.facebook_link);
        }

        if (this.state.profile.twitter_link && this.state.profile.twitter_link.length) {
            fd.append('twitter_link', this.state.profile.twitter_link);
        }

        if (this.state.profile.youtube_link && this.state.profile.youtube_link.length) {
            fd.append('youtube_link', this.state.profile.youtube_link);
        }

        if (this.state.profile.linkedin_link && this.state.profile.linkedin_link.length) {
            fd.append('linkedin_link', this.state.profile.linkedin_link);
        }

        if (this.state.profile.instagram_link && this.state.profile.instagram_link.length) {
