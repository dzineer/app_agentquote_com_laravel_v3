...
class SignUp extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            invoice: {
                total: 60.00,
                note: 'By Clicking "CONTINUE" below, you have agreed to subscribe to the product(s) listed above, and will be billed the amount(s) accordingly.'
            },
            fields: {
                account: {
                    first_name: '',
    ...
    onSubscribe = event => {
        ...
        promise.then( token => {
            ...
            let headers = {
                'Content-Type': 'application/json',
                'token': token,
                'X-Agentquote-Api': 'subscriptions',
                'accountid': '834839489'
            };
