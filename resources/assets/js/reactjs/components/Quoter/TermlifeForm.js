                ...
                <div className="col-md-12">
                    <div className="row">
                        <div className="col-md-6 mt-2 mb-2">
                            <input type="text" name="amount" id="amount" className="form-control form-control-lg" placeholder="Amount" onKeyUp={this.onAmountChange} />
                        </div>
                        <div className="col-md-6 mt-2 mb-2">
                            <select name="benefit" id="benefit" className="form-control form-control-lg" onChange={this.onAmountChange} defaultValue={-1}>
        ...
        this.calenderAgeBlock = (
            <div className="display-block">
                ...
                <div className="row">
                    ...
                    <div className="col-md-5 col-sm-5 col-xs-12 my-2">
                        <select id="birth_month" name="birth_month" className="form-control form-control-lg fill-parent aq2e-month select-box-lg zero-margins select-non-lg d-inline-block" onChange={this.onBannerChange}>
                            { this.generateCalendarOptions('month') }
                        </select>
                    </div>

                    <div className="col-md-2 col-sm-2 col-xs-12 my-2">
                        <select id="birth_day" name="birth_day" className="form-control form-control-lg fill-parent aq2e-day select-box-lg zero-margins select-non-lg d-inline-block"  onChange={this.onBannerChange}>
                            { this.generateCalendarOptions('day') }
                        </select>
                    </div>

                    <div className="col-md-2 col-sm-2 col-xs-12 mt-2">
                        <select id="birth_year" name="birth_year" className="form-control form-control-lg fill-parent aq2e-year select-box-lg zero-margins select-non-lg d-inline-block" defaultValue={1968} onChange={this.onBannerChange}>
