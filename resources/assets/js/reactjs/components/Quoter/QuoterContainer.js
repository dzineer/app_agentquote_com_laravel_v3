...
class QuoterContainer extends Component {
    ...
    componentDidMount() {
        ...
        this.setState({ quoteContainer: <TermlifeForm statesArr={this.stateOptions} /> });
    ...
    onMenuClick = event => {
        ...
        switch( event.target.name ) {
            case 'termlife_menu_item':
                newState.quoteContainer = <TermlifeForm statesArr={this.stateOptions} />;
                newState.menu.term = this.state.menu.active;
                break;
            case 'sit_menu_item':
                newState.quoteContainer = <SitForm statesArr={this.stateOptions} />;
                newState.menu.sit = this.state.menu.active;
                break;
            case 'siwl_menu_item':
                newState.quoteContainer = <SiwlForm statesArr={this.stateOptions} />;
    ...
    render() {
        ...
        return (
            <div className="row">
                ...
                <div className="col-md-12 quote-box-container mb-3">
                    <div className="card">
                        <div className="card-body">
                ...
                <div id="quote-results-container" className="col-md-12 quote-box-container mb-3">
                    <div className="card">
