...
class TermLifeQuoteModule extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            showForm: true,
    ...
    renderEmailMeThisQuote = () => {
        return (
            <input type="submit" id="email-group-btn" className="btn btn-primary" value="email this quote" onClick={this.onGenQuoteRequest} />
        );
    };
        ...
        return (
            <div>
                <form>
                    ...
                    <div className="form-group mb-4 display-flex align-content-center">
