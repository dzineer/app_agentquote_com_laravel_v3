...
/** function: SiwlBanner */
class SiwlBanner extends Component {
    constructor(props) {
        super(props);
        this.banner = '';
        this.loader = {};
            ...
            <div className="date-group" style={this.styles.dateGroup}>
                ...
                <div className="input-group mb-3" style={this.styles.inputGroup}>
                    ...
                    <div className="div-one-third" style={Object.assign({}, this.styles.oneThirdGroup, this.styles.oneThirdGroup.third)}>
                        <select className="custom-select third-select" name="birth_year" id="birth_year" onChange={this.onBannerChange} style={this.styles.select} defaultValue={((new Date().getFullYear() + 50 + new Date().getFullYear())/2).toString()} >
        ...
        this.axios_instance.get('https://banner.aq2e.com/q/g?request='+query+'&response=json').then( res => {
            ...
            let quote_items = quote_results.map((item) => {
                ...
                return (
                    ...
                    <div>
                        <div className="container" style={styles.for.container} key={item.Rate1Adj}>
                            <div className="row">
                                <div className="col-md-2 col-xs-12 image-container" style={styles.for.carrierLogo}><img
                                    className="align-middle img-fluid" src={item.BannerLogoImageURL} alt=""/></div>
                                <div className="col rates-container" style={styles.for.ratesContainer}>
                                    <div className="row">
                                        <div className="col"
                                             style={Object.assign({}, styles.for.ratesContainers, styles.for.ratesContainers.firstChild)}>
                                            <div className="rate-container">
                                                    <span
                                                        style={styles.for.rateClassification}>{item.RateClassification1}</span><br/>
                                                {item.Rate1Adj}
                                            </div>
                                        </div>
                                        <div className="col" style={styles.for.ratesContainers}>
                                            <div className="rate-container">
                                                    <span
                                                        style={styles.for.rateClassification}>{item.RateClassification2}</span><br/>
                                                {item.Rate2Adj}
                                            </div>
                                        </div>
                                        <div className="col" style={styles.for.ratesContainers}>
                                            <div className="rate-container">
                                                    <span
                                                        style={styles.for.rateClassification}>{item.RateClassification3}</span><br/>
                                                {item.Rate3Adj}
                                            </div>
                                        </div>
                                        <div className="col" style={styles.for.ratesContainers}>
                                            <div className="rate-container">
                                                    <span
                                                        style={styles.for.rateClassification}> {item.RateClassification4}</span><br/>
                                                {item.Rate4Adj}
                                            </div>
                                        </div>
                            ...
                            <div className="row">
                                <div className="col-6" style={styles.for.links.link1}>
                                    <a className="link" href="#">Product Guide</a>
                                </div>
                                <div className="col-6" style={styles.for.links.link2}>
                                    <a className="link" href="#">Underwriting Guidelines</a>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col product-name" style={styles.for.productName}>
                                    {item.ProductName}
                                </div>
                            </div>
                        </div>
    ...
    generateBenefitOptions = () => {
        const stops = [
            { start: 1, end: 24, inc: 1 },
            { start: 25, end: 100, inc: 5 }
        ];
    ...
    generateCalendarOptions = (type) => {
        if (type === "day") {
            ...
            return this.range(new Date().getFullYear() - 50, new Date().getFullYear() ).map(y => {
    ...
    getTermYears = () => {
        return [{value: 10, text: '10 Pay'},{value:20, text: '20 Pay'},{value: 121, text: 'Life Pay'}].map( n => {
            return <option key={n.value+n.text} value={n.value}>{n.text}</option>
        })
    };
    ...
    render() {
        ...
        return (
            <div className="quote-container"
                ...
                <h2 style={this.styles.header}>Get An Instant Quote Below (SIWL)</h2>
                <div className="row">
...
SiwlBanner.propTypes = {
    statesArr: PropTypes.array.isRequired
};

SiwlBanner.defaultProps = {
    statesArr: []
};

export default SiwlBanner;
