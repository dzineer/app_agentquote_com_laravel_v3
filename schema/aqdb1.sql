...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2019 at 09:54 AM
...
(7, 7, 'mhrynewich@legacyagent.com', NULL, NULL, 'AgentQuote', NULL, '345 Gold Rd.', NULL, 'Fullerton', 'MD', '92833', NULL, '2018-11-28 09:50:00', '2019-02-11 18:14:29'),
...
(3, 'Demo One', 'demo1@example.com', '$2a$04$Cmi2DdYDNi9lmHUDmSlea.f0j687hleuysLDaitfjI5mnZ6xIf0JC', 3, 'DWgsMG3JjGNelaNVRqTDm0AaxwX2YXISG0Gi0WCyFLcYT0CsbUnmt1Z6CInc', '2018-11-28 09:46:09', '2018-11-28 09:46:09', 'Demo', 'One', NULL),
(4, 'Demo Two', 'demo2@example.com', '$2a$04$Cmi2DdYDNi9lmHUDmSlea.f0j687hleuysLDaitfjI5mnZ6xIf0JC', 4, 'PM1mLHZ0V6n0l37gJ7zmI20NDwRcigvkzEALbTmx0WTSJk1fAWusiCImfJYC', '2018-11-28 09:46:53', '2018-11-28 09:46:53', 'Demo', 'Two', NULL),
...
(6, 'Patrick Pegram', 'ppegram@legacyagent.com ', '$2y$10$tmw6QhyhE2hXO4xL9apuK.XUp6PY6X2aA.9cSrJuI4jwqD34niArW', 6, 'Jbg7DZTDZtTtFTDa09utHhigo2dkaBp9sQYSg1TkR2QFZYkghkXaHgk4F9k1', '2018-11-28 09:49:01', '2019-02-08 06:35:19', 'Patrick', 'Pegram', NULL),
(7, 'Test', 'mhrynewich@legacyagent.com', '$2y$10$v1SmJN6PW/t8GjU1mfZQ/uqxLlvNSDpcRDZrVZqrCcfw3aQn.9bVW', 7, 'CpYkljluXsEmZQBj3etAWHUqP3xCg0mW1vnh1j97zx7qw8d5M2USMRdLsvM3', '2018-11-28 09:50:00', '2019-02-11 18:14:02', 'Michael', 'Hrynewich', NULL),
...
(57, 'Larry Booksh', 'larry@larrybooksh.com', '$2y$10$jU4U69cDpT0ii7zhHuZE2.lTbxO6KRnx2aSF.tScyxHBX0noxjhje', 52, NULL, '2019-02-18 17:10:14', '2019-02-18 17:10:14', 'Larry', 'Booksh', NULL),
...
--
ALTER TABLE `carrier_guides`
  ADD CONSTRAINT `carrier_guides_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories_insurance` (`category_id`),
  ADD CONSTRAINT `carrier_guides_ibfk_2` FOREIGN KEY (`company_id`) REFERENCES `carriers` (`company_id`);
COMMIT;
