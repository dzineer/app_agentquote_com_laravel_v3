        ...
        if ($user->is_super()) {
            ...
            if ($request->has('sortby') && $request->has('order')) {
                ...
                if ( in_array($sortBy,  $sorts) && in_array($request->input('order'), $orders)) {
                    ...
                    $affiliates_with_pagination = $this->getAffiliates($sortBy, $request->input('order'));

                } else {
                    $affiliates_with_pagination = $this->getAffiliates();
                }
...
/*            return response()->json([
                $affiliates_with_pagination
            ]);*/

            $pagination = $affiliates_with_pagination['pagination'];
            ...
            $json = response()->json([
                ...
                'affiliates' => $affiliates_with_pagination['affiliates'],
            ...
            return View::make('affiliate.affiliates-table', [
                'user' => $user,
                'affiliate_id' => $affiliate_id,
                'affiliates' => json_encode($affiliates_with_pagination['affiliates']),
                'pagination' => json_encode($affiliates_with_pagination['pagination']),
                'user_type' => 1,
            ]);

            return view('affiliate.affiliates-table', compact('user', 'affiliate_id', 'users', 'groups', 'user_type') );
