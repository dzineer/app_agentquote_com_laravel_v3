...
class FinalExpensePageModuleController extends Controller
{
    ...
    private function byVanitySubdomain( Request $request ) {
        ...
        $data['rel_path'] = 'landing-pages.v3.quote_modules.final_expense';
        $data['templates_path'] = 'templates/landing-pages/v3/';

        return view( 'landing-pages.v3.quote_modules.final_expense.index', $data );
    }
    ...
    private function initInsureModule( $ip, $mainSessionKey, $defaultState ) {
        ...
        $insureModule[ $mainSessionKey ]['previous_insure_form']               = 'fe';
