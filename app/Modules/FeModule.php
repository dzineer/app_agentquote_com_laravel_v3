...
class FeModule extends CustomModule {

    public function install( $module, $data ) {
        // TODO: Runs once to register as a installed admin module
	...
	public function boot( $module, $data ) {
        ...
        $userModule = CustomModuleUser::updateOrCreate(
            ...
            ['data' => json_encode( $moduleData['parameters'] )]
        );
    ...
    public function onEdit( $module, $data ) {
        ...
        return view('custom_modules.fe_module.settings', ['customModule' => $module, 'customModuleData' => json_encode($module), 'domains' => $domains]);
    }
    ...
    public function onRender( $module, $data ) {
        ...
        $view = View::make('custom_modules.fe_module.render', []);
